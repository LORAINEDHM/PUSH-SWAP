...
#    Updated: 2019/11/22 21:32:01 by lduhamel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_strlcat.c ft_strnstr.c ft_calloc.c ft_strdup.c ft_strjoin.c ft_strtrim.c ft_substr.c \
ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_split.c ft_strmapi.c \
